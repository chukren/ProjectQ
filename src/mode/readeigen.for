...
c
       ...
       read(*,*)freq
        ...
        write(*,*)'reading model file:', file_model
...
91     format(1x,e12.4,1x,f12.5,1x,f12.5,1x,i5,i5,i5)     
       ...
       write(*,*)'1: reading eigenfunction',fileeigf

       open(10,file=fileeigf,form='unformatted')

       write(*,*)'2: reading eigenfunction',fileeigf
       ...
       write(*,*)' love wave engi function', filetest
       ...
       if(no.lt.10) write(filetest,  '(''sensitivity.L.'',i1)' )no  
       if(no.gt.9) write(filetest,  '(''sensitivity.L.'',i2)' )no  
       open(22,file=filetest)
       write(*,*)' love wave sens function', filetest
       ...
       open(20,file=filetest)
       write(*,*)' rayleigh wave engi function : ', filetest 
       ...
       if(no.lt.10) write(filetest,  '(''sensitivity.R.'',i1)' )no  
       if(no.gt.9) write(filetest,  '(''sensitivity.R.'',i2)' )no  
       open(22,file=filetest)
       write(*,*)' rayleigh wave sens function : ', filetest 

       endif


       read(10)rn4,in4,n4,nfreq,nbran,df4,cmax4
       write(*,*)rn4,in4,n4,nfreq,nbran,df4,cmax4
        ...
        do k = 1,mod
         ...
         write(*,*)'T=',(pi2/w4),'vphase=',vphase,'gcom=',gcom,'fl4=',fl4
          ...
          factor = w4 * 6371000 *fact
           ...
           if(k.eq.mod) write(22,*)'function    depth'
...
cc r^2 included in dcdb
               ...
               write(22,5)dcdb,(6371000-radius(ir))/1000
...
cc no direction change
       ...
       write(*,*)'dc/db integreal with depth ',add
